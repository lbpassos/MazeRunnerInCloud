...
public class AmazonDynamoDBModule {
    ...
    */
    ...
    /*public static void main(String[] args) throws Exception {
        ...
        //RequestCoordinate mrc = fromStringToRequestCoordinate("0", "0", "10", "10");
        //int myMteric = getMetric("Maze100.maze", "astar", "1", mrc);
        RequestCoordinate mrc = fromStringToRequestCoordinate("16", "0", "0", "0");
        int myMteric = getMetric("Maze100.maze", "astar", "1", mrc);
        ...
        if(myMteric<0) {
        	...
        	System.out.println("metric: " + myMteric);
        	//insertRequestCoordinateInDynamoDB("Maze100.maze", "astar", "1", mrc, );
        }
        //por metrica
        //insertRequestCoordinateInDynamoDB("Maze100.maze", "astar", "1", mrc, 100);
